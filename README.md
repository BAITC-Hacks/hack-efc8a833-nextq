...
Откройте `/challenge` или ссылку «Проверить план на устойчивость» на главной. Сначала заполните исходные пять решений, затем выберите событие и измените скопированный ответный план. Каждый план ограничен 100 единицами независимо. «Сравнить планы» показывает три AQoL, расход и остаток, эффект события и ответа, а также показатели района события до и после. Изменение решений или события очищает прежний отчёт; возврат к исходному плану при следующем переходе заново копирует его в ответный. Обычный сценарий с AI-разбором остаётся на `/`.
